...
module.exports = function jsForth(lOut, cOut, kIn) {
    ...
    // TODO discard comments & eat whitespace in the beggining
    function _WORD() {
        var str = "";
        do {
            var keyCode = kIn();
    ...
    defword("TESTCREATE", "TESTCREATE", 0, "WORD DUP TELL CREATE TICK DUP COMMA TICK EXIT COMMA EXIT");
    defword("TESTEMIT", "TESTEMIT", 0, "WORD DUP TELL FIND EXIT");
    ...
    defword("QUIT", "QUIT", 0, "TESTCREATE BRANCH -2");
